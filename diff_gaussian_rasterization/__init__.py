...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, contrib, color, feature, radii, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)
        ...
        return contrib, color, feature, radii

    @staticmethod
    def backward(ctx, grad_out_contrib, grad_out_color, grad_out_feature, _):
